...
#include "../../untitled6/studentdialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_StudentDialog_t, stringdata) + ofs \
...
const QMetaObject StudentDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_StudentDialog.data,
      qt_meta_data_StudentDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StudentDialog.stringdata))
